package com.courier.commons.push;
...
public class JPush extends BaseEntity{
    ...
    private Enumerate.ContentType contentType = Enumerate.ContentType.TEXTMESSAGE;
    ...
    public JPush(String[] alias, Map<String, String> extMap, String title, String content, Enumerate.ContentType contentType) {
        this.alias = alias;
        this.extMap = extMap;
        this.title = title;
    ...
    public JPush(String[] alias, Map<String, String> extMap, Enumerate.ContentType contentType) {
        this.alias = alias;
        this.extMap = extMap;
        this.title = contentType.getTitle();
        this.content = contentType.getContent();
        this.contentType = contentType;
    }
    ...
    public Enumerate.ContentType getContentType() {
        return contentType;
    }

    public void setContentType(Enumerate.ContentType contentType) {
        this.contentType = contentType;
    }

    public static void main(String[] args) {
//        JPush push = new JPush(null, false, null, null, null, null);
        JPush push = new JPush();
        push.setAll(true);
        System.out.println("#########"+push.toJson());
//        JPush push1 = new JPush(null,  null, null, null, null);
//        JPush push1 = new JPush();
//        push1.setAll(true);
//        System.out.println("#########"+push1.toJson());
    }
}
