package com.courier.commons.aliwareMq.base.pull.consumer;

import com.aliyun.openservices.ons.api.MessageListener;
import com.aliyun.openservices.ons.api.PropertyKeyConst;
import com.aliyun.openservices.ons.api.bean.ConsumerBean;
import com.aliyun.openservices.ons.api.bean.Subscription;
import com.aliyun.openservices.shade.com.alibaba.rocketmq.client.consumer.MQPullConsumerScheduleService;
 ...
 */
public abstract class BaseConsumer extends ConsumerBean {
    ...
    public void init() throws Exception {
        ...
        if(config == null || StringUtils.isEmpty(config.getAccessKey()) || StringUtils.isEmpty(config.getSecretKey())
            ...
            throw new Exception(" init consumer failed, mandatory parameter is empty");
        ...
        logger.info("base consumer started, topic is {}, tag is {}, consumerId is {}", topic, expression, consumerId);
    }
